...
from nautobot_firewall_models.utils import get_default_status, serializer_to_json
...
class PolicyRule(PrimaryModel):
    ...
    def rule_details(self):
        """A convenience method to convert a PolicyRule into more consumable data structure."""
        row = {}
        row["rule"] = self
    ...
    def to_json(self):
        """A convenience method to convert entire PolicyRule to json, based on serializer."""
        return serializer_to_json(self)
...
class Policy(PrimaryModel):
    ...
    def policy_details(self):
        """A convenience method to convert an entire Policy to a data structure, based on a list of `rule_details`."""
        data = []
    ...
    def to_json(self):
        """A convenience method to convert to entire Policy to json, based on serializer."""
        return serializer_to_json(self)
